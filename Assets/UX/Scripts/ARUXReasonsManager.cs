...
public class ARUXReasonsManager : MonoBehaviour
{
    ...
    const string k_InitRelocalText = "Inicializando Realidade Aumentada.";
    const string k_MotionText = "Tente se mover lentamente.";
    const string k_LightText = "Está muito escuro. Vá para uma área mais iluminada.";
    const string k_FeaturesText = "Procure por mais texturas e detalhes na área.";
    const string k_UnsupportedText = "O conteúdo da RA não é suportado.";
    const string k_NoneText = "Esperando o tracking iniciar.";
